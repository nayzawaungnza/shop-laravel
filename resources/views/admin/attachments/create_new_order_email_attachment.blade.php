...
<head>
    ...
    <style>
       @font-face {
        ...
        font-style: normal;
        font-weight: normal;
        src: url('https://www.gbank.com.mm/Pyidaungsu-Regular.ttf') format('truetype');
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: bold;
            src: url('http://127.0.0.1:8000/fonts/Pyidaungsu-Bold.ttf') format('truetype');
            unicode-range: U+1000-109F, U+AA60-AA7B;
        }
...
<body>
      ...
      <div class="cs-invoice_in" id="download_section">
                ...
                <tr>
                    <td style="border-top: 0px;width:50%;">
                        <div class="cs-invoice_left">
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;" class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Invoice No:</b> #{{ $order->id }}</p>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;" class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date: </b>{{  date('F j, Y', strtotime($order->order_date))}}</p>
                        </div>
                    </td>
                    <td style="border-top: 0px;width:50%;">
                        <div class="cs-invoice_right cs-text_right">
                            <div class="cs-logo cs-mb5" >
                                {{-- <img src="{{ asset('images/online-shop.png') }}" alt="Logo"> --}}
                                <img style="width: 200px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/online-shop.png'))) }}" alt="Logo">
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <div class="cs-invoice_head cs-mb10">
            <table>
                <tr>
                    <td style="border-top: 0px;width:50%;">
                        <div class="cs-invoice_left" style="width: 100%;">
                            <b class="cs-primary_color">Invoice To:</b>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">
                              {{ $order->customer->name }}
                            </p>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">
                            ...
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">
                              {{ $order->shipping_township->name }},
                            </p>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">
                              {{ $order->shipping_state->name }},
                            </p>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">
                                {{ $order->shipping_country->name }}, {{ $order->shipping_zip }}
                            </p>

                            </p>
                          </div>
                    </td>
                    <td style="border-top: 0px;vertical-align: top;width:50%;">
                        <div class="cs-invoice_right cs-text_right">
                            <b class="cs-primary_color">Pay To:</b>
                            <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">Biman Airlines</p>
                              <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">237 Roanoke Road, North York,</p>
                              <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">Ontario, Canada</p>
                              <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">demo@email.com</p>
        ...
        <div class="cs-table cs-style1">
          <div class="cs-round_border">
                ...
                <tbody>
                    @foreach($order->items as $item)
                        <tr>
                            ...
                            {{-- <td class="cs-width_4">{{ $item->product->description }}</td> --}}
                            <td class="cs-width_2">{{ $item->quantity }}</td>
                            <td class="cs-width_1">{{ $item->price }}</td>
                            <td class="cs-width_2 cs-text_right">{{ number_format($item->quantity * $item->price,2) }} MMK</td>
                        </tr>
                    @endforeach
            ...
            <div class="cs-invoice_footer cs-border_top">
                <table>
                    <tr>
                        <td style="border-top: 0px;width:50%;padding: 0px;">
                            <div class="cs-left_footer " style="width:100%;">
                                <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;"><b class="cs-primary_color">Additional Information:</b></p>
                                <p style="font-family: Noto Sans Myanmar,'Pyidaungsu';margin-bottom: 0px;line-height: 1em;">At check in you may need to present the credit <br>card used for payment of this ticket.</p>
                              </div>
                        </td>
                        <td style="border-top: 0px;width:50%;padding: 0px;">
                                    ...
                                    <tr class="cs-border_left">
                                      ...
                                      <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">
                                        ...
                                        @foreach ($order->items as $item)
                                            ...
                                            @endphp
                                        @endforeach
                                        {{ number_format($subtotal,2) }} MMK
                                      </td>
                                    </tr>
                                    <tr class="cs-border_left">
                                      <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Tax</td>
                                      <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ number_format($subtotal * 0.01,2) }} MMK</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
              ...
              <table>
                <tbody>
                  <tr class="cs-border_none">
                    ...
                    <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color cs-text_right">{{ number_format($order->total_amount,2) }} MMK</td>
                  </tr>
                </tbody>
              </table>
            </div>
  ...
  <script src="{{ asset('admin/js/main.invoices.js') }}"></script>
</body>
</html>
