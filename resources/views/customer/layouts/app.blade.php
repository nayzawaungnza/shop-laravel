...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('customer/img/favicon.png') }}">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100 bg-dark">
                        ...
                        <a href="{{ route('customer#productcategoryslug', $category->slug) }}" class="nav-item nav-link text-white">{{ $category->name }}</a>
                        @endforeach

                        @else
                        <p class="text-danger">Have no category.</p>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('customer#index') }}" class="nav-item nav-link active">Home</a>
                            <a href="{{ route('customer#cart') }}" class="nav-item nav-link">My Cart</a>
                            <a href="{{ route('customer#contact') }}" class="nav-item nav-link">Contact</a>
                            <a href="{{ route('customer#signin') }}" class="nav-item nav-link">Sign In</a>
                            <a href="{{ route('customer#signup') }}" class="nav-item nav-link">Sign Up</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                           <ul class="action-list">
                            <li>
                               ...
                               <li>
                                @if (Auth::check())
                                    <a href="{{ route('customer#cart') }}" class="btn px-0 ">
                                ...
                                <li class="my-account">
                                    ...
                                    <div class="my-account-dropdown ">
                                        ...
                                        <div class="login-btn">
                                            <a href="{{ route('customer#signin') }}" class="axil-btn btn-bg-primary">Login</a>
                                        </div>
                                        <div class="reg-footer text-center">No account yet? <a href="{{ route('customer#signup') }}" class="btn-link">REGISTER HERE.</a></div>
                                    </div>
                                </li>
                           </ul>
                        </div>
