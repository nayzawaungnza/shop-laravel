                              ...
                              <tbody>
                                <tr>
                                  <td id="x_601669422header_wrapper" style="padding :  36px 48px; display :  block; ">
                                    <h1 style="font-family :  &quot;Helvetica Neue&quot;, Helvetica, Roboto, Arial, sans-serif; font-size :  30px; font-weight :  300; line-height :  150%; margin :  0; text-align :  left; text-shadow :  0 1px 0 #33ad33; color :  #fff; background-color :  inherit; ">New Order: #{{ $order->id }}</h1>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                                        ...
                                        <tr>
                                          <td style="padding :  48px 48px 32px; " valign="top">
                                            <div id="x_601669422body_content_inner" style="color :  #636363; font-family :  &quot;Helvetica Neue&quot;, Helvetica, Roboto, Arial, sans-serif; font-size :  14px; line-height :  150%; text-align :  left; " align="left">
                                              <p style="margin :  0 0 16px; "> You’ve received the following order from <b>{{ $order->customer->name }}</b>:</p>
                                              ...
                                              <p style="margin :  0 0 16px; ">Congratulations on the sale.</p> Process your orders on the go. <a href="!@" style="color :  rgb(42, 209, 157); font-weight :  normal; text-decoration :  underline; " target="_blank">Get the app</a>.
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
